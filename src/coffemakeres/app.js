import { coffeeStock, isCoffeeMakerReady } from './statekopi';
...
const coffeOrderButtonEl = document.querySelector('#coffee-order-button');
coffeOrderButtonEl.addEventListener('click', (event) => {
    event.preventDefault();
    coffeeOrderButtonEventHandler(event);
});
